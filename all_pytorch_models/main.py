...
from all_pytorch_models.api import (mnist_predict, fashion_mnist_predict, cifar10_predict,
                                    ...
                                    image_scene_predict, trash_predict)
...
all_pytorch_models_app.include_router(trash_predict.trash_predicted)

if __name__ == '__main__':
    uvicorn.run(all_pytorch_models_app, host='127.0.0.1', port=8001)
